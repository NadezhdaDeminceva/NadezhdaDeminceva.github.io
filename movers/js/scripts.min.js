...
$(function() {
	...
	$('.img-container').height($('.img-container').width()/1.9);
	...
	$('#house-removals-item').on('click', function () {
		$('input').prop('checked', false);
		$('#house-removals').prop('checked', true);
	});
	$('#waste-removal-item').on('click', function () {
		$('input').prop('checked', false);
		$('#waste-removal').prop('checked', true);
	});
	$('#office-removals-item').on('click', function () {
		$('input').prop('checked', false);
		$('#office-removals').prop('checked', true);
	});
	$('#car-order-item').on('click', function () {
		$('input').prop('checked', false);
		$('#car-order').prop('checked', true);
	});
